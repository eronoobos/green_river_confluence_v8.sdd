...
--// Options
	...
	--// Economy
	{
		...
		def  = 'normal',
		items	= {
			{ key = 'low', name = "Unqual Low", desc = "Low metal density, two metal spot sizes" },
			{ key = 'normal', name = "Unequal Normal", desc = "Default metal density, two metal spot sizes" },
			{ key = 'high', name = "Unequal High", desc = "High metal density, two metal spot sizes" },
			{ key = 'eqlow', name = "Equal Low", desc = "Low metal density, one metal spot size" },
			{ key = 'eqnormal', name = "Equal Normal", desc = "Default metal density, one metal spot size" },
			{ key = 'eqhigh', name = "Equal High", desc = "High metal density, one metal spot size" },
		},
	},
